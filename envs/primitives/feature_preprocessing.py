...
from sklearn.preprocessing import MaxAbsScaler, MinMaxScaler, RobustScaler, QuantileTransformer, PowerTransformer,\
    Normalizer, KBinsDiscretizer, StandardScaler, FunctionTransformer, Binarizer, LabelBinarizer, MultiLabelBinarizer
...
class FunctionTransformerPrim(primitive):
    def __init__(self, random_state=0):
        super(FunctionTransformerPrim, self).__init__(name='FunctionTransformer')
        self.id = 11
        self.hyperparams = []
        self.type = 'feature preprocess'
