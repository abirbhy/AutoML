...
from sklearn.ensemble import RandomForestClassifier, AdaBoostClassifier, BaggingClassifier, RandomForestRegressor, \
    ExtraTreesClassifier, GradientBoostingClassifier, AdaBoostRegressor, ExtraTreesRegressor, GradientBoostingRegressor
...
class AdaBoostRegressorMetaPrim(primitive):
    def __init__(self, random_state=0):
        super(AdaBoostRegressorMetaPrim, self).__init__(name='AdaBoostRegressorMeta')
        self.hyperparams = []
        self.type = 'ensemble'
        self.description = "An AdaBoost regressor."
        self.hyperparams_run = {'default': True}
        self.random_state = random_state
        self.model = AdaBoostRegressor(random_state=self.random_state)
...
class ExtraTreesRegressorMetaPrim(primitive):
    def __init__(self, random_state=0):
        super(ExtraTreesRegressorMetaPrim, self).__init__(name='ExtraTreesRegressorMeta')
        self.hyperparams = []
        self.type = 'ensemble'
        self.description = "An extra-trees regressor."
        self.hyperparams_run = {'default': True}
        self.random_state = random_state
        self.model = ExtraTreesRegressor(random_state=self.random_state, n_jobs=5)
        self.accept_type = 'c_r'
...
class GradientBoostingRegressorMetaPrim(primitive):
    def __init__(self, random_state=0):
        super(GradientBoostingRegressorMetaPrim, self).__init__(name='GradientBoostingRegressorMeta')
        self.hyperparams = []
        self.type = 'ensemble'
        self.description = "Gradient Boosting for regression."
        self.hyperparams_run = {'default': True}
        self.random_state = random_state
