...
from . primitives.data_preprocessing import Imputer, OneHotEncoderPrim, LabelEncoderPrim, ImputerIndicatorPrim,\
    NumericDataPrim, ImputerEncoderPrim, ImputerMedian, ImputerOneHotEncoderPrim, OrdinalEncoderPrim
from gym_deepline.envs.primitives.feature_preprocessing import KBinsDiscretizerOneHotPrim, NormalizerPrim, PowerTransformerPrim,\
    ...
    StandardScalerPrim, FunctionTransformerPrim
...
RandomForestRegressorPrim, ExtraTreesRegressorPrim, GradientBoostingRegressorPrim, LinearRegressionPrim, RidgePrim,\
LassoLarsPrim, ElasticNetPrim, SGDRegressorPrim, DecisionTreeRegressorPrim, KNeighborsRegressorPrim,\
GaussianProcessRegressorPrim, SVRPrim, LinearSVRPrim, XGBRegressorPrim, LGBMRegressorPrim

from . primitives.ensemble import MajorityVotingPrim, RandomForestMetaPrim, RandomForestRegressorMetaPrim, \
AdaBoostClassifierMetaPrim, ExtraTreesClassifierMetaPrim, GradientBoostingClassifierMetaPrim, XGBClassifierMetaPrim, \
AdaBoostRegressorMetaPrim, ExtraTreesRegressorMetaPrim, GradientBoostingRegressorMetaPrim, XGBRegressorMetaPrim
# import primitives
...
primtive_modules = {
    ...
    'Prediction': regressor_primitives,
    'ensemble': ensemble
}
...
primitives = {
    ...
    'Prediction': [RandomForestClassifierPrim, AdaBoostClassifierPrim, BaggingClassifierPrim,
                       ...
                       RandomForestRegressorPrim, ExtraTreesRegressorPrim, GradientBoostingRegressorPrim,
                       LinearRegressionPrim, RidgePrim, LassoLarsPrim, ElasticNetPrim, SGDRegressorPrim,
                       DecisionTreeRegressorPrim, KNeighborsRegressorPrim, GaussianProcessRegressorPrim, SVRPrim,
                       LinearSVRPrim, XGBRegressorPrim, LGBMRegressorPrim],
    'ensemble': [MajorityVotingPrim, RandomForestMetaPrim, RandomForestRegressorMetaPrim, AdaBoostClassifierMetaPrim,
                 ...
                 AdaBoostRegressorMetaPrim, ExtraTreesRegressorMetaPrim, GradientBoostingRegressorMetaPrim,
                 XGBRegressorMetaPrim]
}
...
EXCLUDE_META_FEATURES_CLASSIFICATION = {
    'LandmarkDecisionTreeRegression',
    'Landmark1NN',
...
class Observation:
    def __init__(self, level=1, mode='train'):
        ...
        self.all_learning_jobs = LearningJob.load_all_learning_jobs(mode=mode, metric=R2())
    ...
    def get_base_pipelines(self):
        baselines = [RandomForestRegressorPrim, ExtraTreesRegressorPrim, XGBRegressorPrim]
        pipelines = {}
    ...
    def compute_baselines(self):
        baselines = [RandomForestRegressorPrim, ExtraTreesRegressorPrim, XGBRegressorPrim, LinearSVRPrim,
                     LinearRegressionPrim, GradientBoostingRegressorPrim, KNeighborsRegressorPrim,
                     DecisionTreeRegressorPrim]
...
class AutomlEnv(gym.Env):
    ...
    def set_env_params(self, primitives_list=None, lj_list=None, cv_reward=False, print_scores=False, level=3,
                       reset_regressor=True, split_rate=0.8, random_state=42, baselines_rewards=True,
                       heirarc_step=True, embedd_size=None, log_pipelines=True):
        ...
        if baselines_rewards:
            ...
            self.observation.get_base_pipelines()
